...
namespace OdontoPrevMLTrainer
{
    ...
    {
        /// <summary>
        /// model input class for ComplexidadeModel.
        /// </summary>
        ...
        public class ModelInput
        {
            ...
            public string Sintomatico { get; set; }
        ...
        /// <summary>
        /// model output class for ComplexidadeModel.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            [ColumnName(@"TipoTratamento")]
            public float[] TipoTratamento { get; set; }

            [ColumnName(@"Idade")]
            public float Idade { get; set; }

            [ColumnName(@"Sintomatico")]
            public float[] Sintomatico { get; set; }

            [ColumnName(@"Complexidade")]
            public uint Complexidade { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("ComplexidadeModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Complexidade");
            if (labelColumn == null)
            {
                throw new Exception("Complexidade column not found. Make sure the name searched for matches the name in the schema.");
            }
